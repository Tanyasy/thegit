    ...
    export default {
        ...
        setup() {
            ...
            watch(timeList, (afterValue, beforeValue) => {
                    if (afterValue) {
                        // 通过day.js将时间格式化
                        // const startTime = dayjs(afterValue[0]).format('YYYY-MM-DDTHH:mm:ss')
                        // const endTime = dayjs(afterValue[1]).format('YYYY-MM-DDTHH:mm:ss')
                        // console.log(dayjs(afterValue[0]).format('YYYY-MM-DDTHH:mm:ss'))
